...
* Verified collateral return reset handling with regression coverage so later ledger validation checks remain reliable.
...
- Added ratification state and committee member state queries for Conway era.
