...
blinklabs.ioからBursaのCLI用のバイナリまたはアーカイブ、各プラットフォーム用のインストーラーをダウンロードするだけです。その後、コマンドラインまたはAPIでBursaを実行します。
...
## ステップ1 - BlinklabsからCLI用のバイナリまたはアーカイブ、各プラットフォーム用のインストーラーをダウンロード
<br>
