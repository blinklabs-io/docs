...
これによりMithrilアーティファクトをダウンロードしてデータベースにロードし、数時間の同期時間を節約できます。詳細は[クイックスタートガイドのステップ4：Mithrilアーティファクトからのブートストラップ](../002-quick-start-overview#ステップ4---mithrilアーティファクトからのブートストラップ)を参照してください。
