...
⚠️ お使いのシステムに合わせて、バージョン（以下の例ではv0.61.4）とアーキテクチャを調整してください。

```
mkdir -p ~/dingo
cd ~/dingo
wget https://github.com/blinklabs-io/dingo/releases/download/v0.62.0/dingo-v0.62.0-linux-amd64.tar.gz -O - | tar -xz
```
