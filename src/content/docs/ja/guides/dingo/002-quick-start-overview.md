...
⚠️ お使いのシステムに合わせて、バージョン（以下の例ではv0.63.0）とアーキテクチャを調整してください。

```
mkdir -p ~/dingo
cd ~/dingo
wget https://github.com/blinklabs-io/dingo/releases/download/v0.63.0/dingo-v0.63.0-linux-amd64.tar.gz -O - | tar -xz
```
