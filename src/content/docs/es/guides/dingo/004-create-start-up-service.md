...
> 📝 Después de actualizar una base de datos existente desde una versión anterior, Dingo puede reconstruir automáticamente los metadatos de `reward live-stake` antes de reanudar el procesamiento normal del ledger si detecta agregados almacenados incompletos. Este comportamiento no requiere opciones adicionales ni cambios de configuración.
