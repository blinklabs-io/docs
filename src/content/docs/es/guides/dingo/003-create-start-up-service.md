...
databasePath: \"$HOME/dingo/.dingo\"
 ...
 # false es el valor normal y predeterminado; true es solo para diagnóstico avanzado.
 # Con true, Dingo omite únicamente el análisis de coherencia de inicio de `reward_live_stake`.
