...
Durante la puesta al día de una base de datos completa, Dingo rechaza cualquier pin explícito. Si una importación se detiene, Dingo reanuda con la identidad de artefacto que conserva de forma persistente y rechaza cualquier pin diferente.
...
Esto descarga y carga un artefacto de Mithril en la base de datos, ahorrando horas de tiempo de sincronización. Consulta el [Paso 4 de la guía de inicio rápido: iniciar desde un artefacto de Mithril](../002-quick-start-overview#paso-4---iniciar-desde-un-artefacto-de-mithril) para más detalles.
