...
`signer.keys[].allowed_requests` debe incluir `opcert` para autorizar solicitudes de firma de certificados operativos. Bursa deniega estas solicitudes cuando la política de la clave no incluye `opcert`:
