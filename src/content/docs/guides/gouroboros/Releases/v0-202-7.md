...
* Hardened **transaction and redeemer index validation:** Alonzo and Dijkstra now reject indices that overflow the platform integer type or fall outside the relevant collection bounds, including on 32-bit builds.
