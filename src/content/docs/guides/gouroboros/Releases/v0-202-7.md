...
* Hardened **transaction and redeemer index validation:** Alonzo and Dijkstra now reject invalid indices consistently, including values too large for an encoded transaction field or outside the valid range on 32 bit builds.
