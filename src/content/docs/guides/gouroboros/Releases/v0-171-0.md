...
* Clarified **example source guidance:** Documentation and local workflows should use the final `examples/` path and should no longer describe the examples as coming from the retired starter kit repository.
