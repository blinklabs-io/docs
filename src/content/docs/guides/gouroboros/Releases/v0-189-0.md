...
* Updated **CBOR modernization:** CBOR-related code now uses the modernized implementation path without changing user-facing behavior.

* Cleaned up **issue-closed workflow automation:** Removed the issue-closed workflow automation files from the repository.
