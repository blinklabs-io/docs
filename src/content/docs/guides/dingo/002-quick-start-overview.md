...
> 💡 `metricsPort: 12798` is intended for Prometheus and Grafana monitoring. Dingo v0.38.0 also includes a published dashboard set that covers node overview, block production, peer health, mempool activity, and resource usage.
