...
* Fixed **avoid unnecessary Mithril based rewinds during catch up:** Dingo now avoids unnecessary rewinds during Mithril based catch up when the ledger tip is already on the primary chain, which preserves forward replay and keeps recovery cleaner.
