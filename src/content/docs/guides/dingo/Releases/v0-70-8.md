...
* Serialized `Node.Stop` with active `Restore`, `Truncate`, and `Snapshot` operations under one shutdown deadline, canceled early, waited to acquire lifecycle gates, and kept shutdown retryable after a lifecycle-gate timeout.
