...
* Serialized `Node.Stop` with active `Restore`, `Truncate`, and `Snapshot` operations under one shutdown deadline, canceled early, waited for lifecycle gates, and kept shutdown retryable after a lifecycle-gate timeout.
