...
* Clarified **safer post plateau recovery:** Resync now starts on a fresh connection after peers fall out of alignment, which makes recovery safer after plateau events.
* Emphasized **more responsive governance and pool reads:** Governance and pool oriented database reads should feel more responsive because of the new indexes.
* Reinforced **stronger rollback coverage and release guidance:** Rollback focused coverage improved in this patch release, and the release history is easier to track because v0.46.2 notes are now documented.
