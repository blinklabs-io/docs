...
* Clarified pipeline backpressure and shutdown drain reporting with dedicated Prometheus counters and `DEBUG` logs, separating expected conditions from unexpected errors.
...
* Expanded point-pinned LocalStateQuery support for historical stake distribution, protocol parameters, and UTxO-by-transaction reconstruction. The queries use as-of-slot state, fail closed when history is unavailable, and enforce aggregate reference-script budgets during block admission and forging.

**Full Changelog:** [v0.70.8...v0.70.9](https://github.com/blinklabs-io/dingo/compare/v0.70.8...v0.70.9)
