...
* Hardened startup by failing on unreadable or malformed Mithril trust-boundary slot state while keeping hash reconstruction failures non-fatal.
...
* Memoized successful UTxO reads per `LedgerView`, improving the supplied benchmark and read-count results.
