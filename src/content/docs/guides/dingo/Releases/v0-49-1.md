...
* Added **give SQL focused operators clearer database guidance:** The new database guide maps the SQL store, common query paths, and storage behavior so database workflows are easier to understand and operate.

### 💪 Improvements

* Improved **keep recent release history easier to review:** The published release coverage now includes the previous release entry, which makes recent Dingo changes easier to track.

* Enhanced **keep core dependencies current for smoother operation:** Updated underlying components help Dingo stay aligned with current upstream behavior and maintenance updates.
