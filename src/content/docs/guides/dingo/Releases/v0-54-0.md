...
* Streamlined **refresh Midnight service bindings more consistently:** Dingo now vendors the Acropolis `midnight_state.proto` definition and adds gRPC code generation, which keeps the Midnight service surface aligned for teams that depend on it.
