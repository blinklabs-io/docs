...
* Delayed completion of read results until cached boundary batches were applied, and used the shared verifier for operational certificates that were not cached.
