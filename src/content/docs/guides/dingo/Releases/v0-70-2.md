...
* Preserved the configured shutdown deadline during live restore and truncate operations, and escalates to `errStorageDrainUnconfirmed` when the supervisor needs restart recovery.
