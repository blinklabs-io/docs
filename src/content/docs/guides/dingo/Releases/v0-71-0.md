...
* Improved protocol compatibility by upgrading `gouroboros` to `v0.205.7`, enforcing strict Alonzo protocol parameter provenance, supporting protocol parameter migration v20, protecting restores, matching era specific `coins_per_utxo_size` behavior, enforcing transaction submission bounds, and applying unified recovery validation.
