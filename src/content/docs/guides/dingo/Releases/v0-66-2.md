...
This release updates the Go toolchain and several dependencies, improves Leios NtC CertRB handling, expands MySQL conformance coverage and local validation, simplifies UTXO cleanup, and keeps reward live stake queries aligned with current state.
...
* Recorded the v0.66.1 release entry to keep the release history current.
