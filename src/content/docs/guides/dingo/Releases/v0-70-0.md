...
* Enhanced the Sundae Preview example's development and build tooling by updating the `vite` development dependency in `examples/dingo-sundae-preview` from `8.2.0` to `8.2.1` and refreshing the matching lockfile and dependency graph.
