...
* Released the transaction commit barrier on every terminal path, including blob synchronization failures, so later writers and snapshot operations do not stall.
