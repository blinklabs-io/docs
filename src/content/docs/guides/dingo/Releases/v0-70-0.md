...
* Released the transaction commit barrier exactly once on every terminal path, including blob synchronization failures, so later writers and snapshot operations do not stall.
