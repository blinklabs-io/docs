...
* Ensured every transaction completes cleanly, including blob synchronization failures, so later writers and snapshot operations continue without stalling.
