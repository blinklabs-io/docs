...
This release improves historical LocalStateQuery results, validates Mithril governance and bootstrap state, improves peer recovery and stake distribution accuracy, and adds stronger topology and database safeguards. It also strengthens diagnostic audit behavior, persistence safety, observability, and dependency maintenance.
...
* Corrected local state query connection setup to keep trusted query handling aligned with its updated configuration.
