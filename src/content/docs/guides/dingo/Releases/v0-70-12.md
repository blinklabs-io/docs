...
* Narrowed the `RewardStakeCalculationVersion` startup and rebootstrap gate, added migration v15 to restamp safe snapshot rows, and reported the affected epochs.
