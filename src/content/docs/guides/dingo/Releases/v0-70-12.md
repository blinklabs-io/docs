...
* Fixed the LocalStateQuery test call by passing the required `false` value for `trusted`, allowing `go vet ./ouroboros/...` to complete successfully without changing runtime behavior.
