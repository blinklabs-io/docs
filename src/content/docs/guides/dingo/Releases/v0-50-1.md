...
* Corrected **report recent chain progress more accurately:** Dingo now measures recent chain progress more accurately, which makes health signals more dependable.
* Reduced **avoid repeated next epoch recalculation:** Dingo now skips unnecessary repeated next epoch recalculation during slot updates, which reduces unneeded ledger work.
