...
* Made MIR boundary application atomic, added pot capacity checks, and made effects that exceed the available capacity no ops.
...
* Added support for Dijkstra governance epochs and retained protocol parameters across restarts.
