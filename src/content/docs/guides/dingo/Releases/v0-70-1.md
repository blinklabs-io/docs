...
* Preserved prior Koios parity mismatch evidence when checks fail or mismatch replacement fails by waiting for required reads to succeed and replacing mismatches atomically.
