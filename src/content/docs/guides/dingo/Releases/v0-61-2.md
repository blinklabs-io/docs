...
This release improves peer recovery, Mithril and Leios handling, outbound connectivity, and archive safety.
...
* Updated `gouroboros` through `v0.186.2` and `v0.186.3` so Dingo picks up the latest upstream fixes and compatibility updates.
