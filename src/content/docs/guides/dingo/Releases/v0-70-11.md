...
* Strengthened recovery from malformed reference scripts and witnesses by treating them as deterministic validation failures that rewind and re intersect instead of retrying indefinitely.
