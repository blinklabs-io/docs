...
* Added a mainnet Conway PlutusV3 stored-output fixture that verifies script-context PlutusData against block decoding and declared budgets without changing production behavior.

* Updated Vite in the `dingo-sundae-preview` example from `8.2.2` to `8.3.0`.

* Advanced the `connectrpc.com/connect` dependency from `1.20.0` to `1.21.0`.
