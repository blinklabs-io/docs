...
* Modernized **avoid duplicate Leios recovery transactions:** Dingo now skips duplicate endorser transactions during Leios recovery, which avoids repeated submissions while recovery continues.

* Streamlined **handle large Leios batches more smoothly:** Dingo now chunks large Leios batches during Leios recovery, which improves large batch handling while recovery continues.
