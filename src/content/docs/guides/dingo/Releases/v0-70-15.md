...
* Bounded committee authorization pruning by a live immutable slot derived from `securityParam`, suspended pruning when that slot is unknown, invalidated the pruning state after rollback, and documented synchronization behavior.
