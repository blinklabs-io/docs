...
You can check if you are scheduled to mint block by running the slot leader check in the cardano-cli. This can be done for the current Epoch or the next Epoch within 48 hours of the end of the Epoch.
