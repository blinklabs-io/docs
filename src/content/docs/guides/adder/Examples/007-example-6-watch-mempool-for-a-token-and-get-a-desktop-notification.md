---
title: Watch Mempool for a transaction with a Token and get a Desktop Notification
description: Adder Example 6 - Watch Mempool for a Transaction with a Token and get a Desktop Notification.
---
...
We need to specifiy the IP and Port for the mempool of a Cardano Node that we want to use to monitor. 

✅ TCP address of the node to connect to in the form ‘host:port’

```
---input-mempool-address backbone.cardano.iog.io:3001
```
...
```
C:\Users\richm\Desktop\adder-v0.39.1-windows-amd64.exe ---input-mempool-address backbone.cardano.iog.io:3001 --filter-type input.transaction --filter-asset asset1uaxup2yv695uat3chgwqtpg9xvau55pd5z6r46 --output notify
```

### Congratulations!

Now you can minimize the window and let Adder run in the background. Anytime a transaction appears in our mempool containing cTOSI you will get a desktop alert.
