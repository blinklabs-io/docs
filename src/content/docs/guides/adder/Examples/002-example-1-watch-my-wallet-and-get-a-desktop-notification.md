...
<img src="/adder-receive-address.png"
     alt="adder-receive-address"
...
Staking Address:
<img src="/adder-staking-address.png"
     alt="adder-staking-address"
     style="max-width:100%; height:auto; max-height:500px; object-fit:contain; border:1px solid #ccc;" />
...
> ⚠️ Please make sure you replace the below stake address with your receive or stake address from [Step 1](#step-1)
...
<img src="/adder-final-ex-1-command.png"
...
5. [Example 5](../006-example-5-watch-an-drep-and-get-an-alert-in-telegram) - Watch a DRep and get an Alert in Telegram
