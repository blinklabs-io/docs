...
* Updated **keep the Telegram output library current:** Adder now uses a newer `github.com/go-telegram/bot` release so Telegram output stays aligned with the latest dependency set.
