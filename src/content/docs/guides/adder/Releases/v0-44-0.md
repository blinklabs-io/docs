...
* Extended **Cardano state access:** Adder now supports the `GetAccountState` query, updates its Dijkstra era and Leios integration, and enables validation in the processing pipeline.
