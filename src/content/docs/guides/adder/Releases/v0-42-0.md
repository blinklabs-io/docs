...
* Refined **keep releases reliable across platform specific work:** Adder now pins macOS builds to `macos-15`, separates app packaging from signing and notarization, prevents one failed platform from cancelling the full release process, and allows publication to continue when draft release creation succeeds.
...
* Polished **keep automated builds and release preparation current:** Adder now updates release automation dependencies, which helps automated builds and release preparation stay current and reliable.

* Streamlined **keep signing and publication reliable:** Adder now updates signing automation dependencies, which helps automated signing and release publication stay current and dependable.
