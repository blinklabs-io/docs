...
* Refined **keep release publication reliable across platform specific work:** Adder now pins macOS builds to `macos-15`, separates app packaging from signing and notarization, prevents one failed platform from cancelling the full build matrix, and allows release publication to continue when draft release creation succeeds.
...
* Polished **keep automated builds and release workflows current:** Adder now tracks newer release workflow dependencies, which helps automated builds and release preparation stay current and reliable.

* Streamlined **keep signing and publication workflows reliable:** Adder now tracks newer signing workflow dependencies, which helps automated signing and release publication stay current and dependable.
