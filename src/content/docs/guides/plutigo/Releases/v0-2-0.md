...
* Refreshed **Go setup workflow:** The workflow now pins `actions/setup-go` at `v7.0.0`, keeping build workflows current.
* Updated **checkout workflow:** The workflow now pins `actions/checkout` at `v7.0.1`, keeping build workflows current.
