...
This update strengthens dependency safety checks and malformed input handling while preserving Plutigo's local APIs, flags, configuration, and runtime behavior.
