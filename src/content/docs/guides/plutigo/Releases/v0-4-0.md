...
This release makes constructor tags variant-aware, strengthens upstream validation and malformed data handling, and keeps formatting checks clean. The constructor-tag changes update public Go types and runtime behavior across Plutus variants and serialization formats.
...
The dependency and formatting fixes in this section strengthen safety checks and malformed input handling without changing Plutigo's local APIs, flags, configuration, or runtime behavior.
