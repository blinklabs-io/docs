...
Use `plutigo-replay` to run normalized mainnet parity corpora and replay cases. The [mainnet replay corpus guide](/guides/plutigo/002-mainnet-replay-corpus/) describes the corpus format and replay workflow.
